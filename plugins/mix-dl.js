...
cmd({
  ...
  try {
    ...
    await conn.sendMessage(from, {
      ...
      caption: `📥 *JERRY-MD FB DOWNLOADER..🚀*\n\n*QUAILTY•${videoData.quality}*\n\n🔗 *ᴊᴇʀʀʏ ᴍᴅ*`
    }, { quoted: m });
...
async (conn, mek, m, { from, args, q, reply, react }) => {
    try {
        ...
        const captionText = `*JERRY-MD IG DOWNLOADER🚀*` +
                            `📸 *Instagram Post* 📸\n\n` +
...
async (conn, mek, m, { from, args, q, reply }) => {
    try {
        ...
        reply("*_JERRY-MD DOWNLOADING TIKTOK VIDEO , PLEASE WAIT...🚀_*");
        ...
        const caption = `🎵 *JERRY-MD TIKTOK VIDEO* 🎵\n\n` +
